...
class AgileToolsSetup:
    ...
    def _setup_slack(self, tool_id: str) -> None:
        ...
        import subprocess
        subprocess.run([sys.executable, ".claude/scripts/slack-integration.py"])
...
python .claude/scripts/github-integration.py create-issue
'''
...
python .claude/scripts/github-integration.py auto-pr
'''
"""
...
'''
        ...
        script_path = Path(".claude/scripts/jira-automation.py")
