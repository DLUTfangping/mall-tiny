...
class MCPServerSetup:
    def __init__(self):
        ...
        self.mcp_servers = {
            ...
            "jira": {
                ...
                "command": "python",
                "args": [".claude/scripts/mcp-servers/jira-server.py"],
                "env": {
                    "JIRA_URL": "${JIRA_URL}",
            ...
            "slack": {
                ...
                "command": "python",
                "args": [".claude/scripts/mcp-servers/slack-server.py"],
            ...
            "confluence": {
                ...
                "command": "python",
                "args": [".claude/scripts/mcp-servers/confluence-server.py"],
                "env": {
            ...
            "docker": {
                ...
                "command": "python",
                "args": [".claude/scripts/mcp-servers/docker-server.py"]
            },
            "kubernetes": {
                "name": "Kubernetes Management",
                "description": "Manage K8s deployments",
                "command": "python",
                "args": [".claude/scripts/mcp-servers/k8s-server.py"],
            ...
            "analytics": {
                ...
                "command": "python",
                "args": [".claude/scripts/mcp-servers/analytics-server.py"]
            },
            "testrunner": {
                "name": "Test Runner",
                "description": "Execute and monitor tests",
                "command": "python",
                "args": [".claude/scripts/mcp-servers/test-server.py"]
            },
            "monitoring": {
                "name": "Monitoring Integration",
                "description": "Access logs and metrics",
                "command": "python",
                "args": [".claude/scripts/mcp-servers/monitoring-server.py"],
                "env": {
    ...
    def interactive_setup(self) -> None:
        ...
        if response == "c":
            ...
            print("   python .claude/scripts/mcp-server-setup.py")
            return
    ...
    def _create_server_implementations(self, server_ids: List[str]) -> None:
        ...
        servers_dir = Path(".claude/scripts/mcp-servers")
