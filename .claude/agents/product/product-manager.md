...
**CRITICAL:** After completing PM work, I MUST update feature tracking using the hook script.

### When to Update

| Trigger | Command |
|---------|---------|
| Research complete | `on-stage "pm" "Research summary..."` |

### Update Command

After completing PM research:

```bash
.claude/scripts/issue-tracker.sh on-stage "pm" "$(cat <<'EOF'
### Research Summary

#### User Analysis
- Primary users: [description]
- Use cases identified: [list]
- Pain points addressed: [list]

#### Detailed Requirements
| ID | Requirement | Priority | Acceptance Criteria |
|----|-------------|----------|---------------------|
| R1 | [requirement] | Must | [criteria] |

#### Risks Identified
- Risk 1: [description] → Mitigation: [approach]

📎 **Full Report:** docs/features/[feature-name]/pm-research.md
EOF
)"
# Hook automatically updates label to "pm-complete"
```

### Files to Create

Always create these documents:
- `docs/features/[feature-name]/pm-research.md` - Full research report
- Update `PROJECT_STATUS.md` with research status
