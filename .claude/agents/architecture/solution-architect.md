...
**When to use:** When evaluating Bun as a runtime for new projects, comparing Bun vs Node.js for technology selection, designing systems that leverage Bun's performance advantages, or architecting high-performance JavaScript/TypeScript applications. Triggers: Bun, bun.sh, Bun architecture, Bun vs Node.js, JavaScript runtime selection.

**How to use:** This skill provides Bun architecture patterns and technology evaluation guidance. When making architecture decisions:
1. Compare Bun's 4x faster startup for serverless/edge computing
2. Evaluate Bun's native SQLite for embedded database needs
3. Consider Bun.serve's 2.5x performance over Node.js HTTP
4. Assess migration path from Node.js to Bun
...
|-----------|---------|------------|
| apps/web | [description] | [Low/Med/High] |
| apps/api | [description] | [Low/Med/High] |
...
# Hook automatically updates label to "architecture-complete"
```
